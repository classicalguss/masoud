...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('device_type, device_token, user_name', 'required'),
			array('device_type, device_token, user_name', 'length', 'max'=>200),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, device_type, device_token, user_name', 'safe', 'on'=>'search'),
		);
	}
